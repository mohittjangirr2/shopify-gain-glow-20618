    ...
    <div className="min-h-screen bg-background pb-16">
      ...
      <main className="container mx-auto px-4 py-4 md:px-6 md:py-8">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4 md:grid-cols-4 md:gap-4 md:mb-8">
          ...
          <MetricCard title="ROI" value={`${analytics.roi.toFixed(1)}%`} icon={Target} variant="default" />
          <MetricCard title="RTO" value={`${analytics.rtoPercentage.toFixed(1)}%`} icon={AlertCircle} variant={analytics.rtoPercentage > 10 ? "warning" : "success"} />
        </div>
